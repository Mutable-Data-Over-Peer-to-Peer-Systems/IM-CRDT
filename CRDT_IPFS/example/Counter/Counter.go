...
func (self *CRDTCounterOpBasedDag) Merge(cids []CRDTDag.EncodedStr) {
...
func Create_CRDTCounterOpBasedDag(sys *IpfsLink.IpfsLink, storage_emplacement string, bootStrapPeer string, key string) CRDTCounterOpBasedDag {
